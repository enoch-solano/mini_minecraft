...
glm::mat4 Camera::getHUDOrient() const
{
    return glm::translate(glm::mat4(), glm::vec3(0,0,-2)) * glm::transpose(glm::mat4(glm::vec4(right, 0.f),
                          glm::vec4(up, 0.f),
                          glm::vec4(look, 0.f),
...
glm::mat4 Camera::getHUDProjection() const {
